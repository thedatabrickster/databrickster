...
You do not need to memorize this table. Just know that when you open a trace, each span is labeled, and the label tells you what kind of step you're looking at — which tells you where to go for a given question.
...
Reading a trace is the skill everything else in Part 5 and Part 6 builds on.

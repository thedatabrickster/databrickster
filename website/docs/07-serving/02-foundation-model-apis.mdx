...
Let us narrate the query step. Notice how little changed: you point `model` at **your endpoint name** instead of a shared model name. Everything else is the same.

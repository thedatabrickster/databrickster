...
**3. Synthetic, then human-reviewed.** You use an LLM to generate plausible questions (and draft expected answers) from your source documents, then a human checks them before they go in. This gets you volume fast (more on this next).

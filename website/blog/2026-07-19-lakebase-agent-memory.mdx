...
title: "Context Is Everything: Building Agent Memory on Lakebase"
...
The lab exercises the system across several conversations. Three moments make the
short-term/long-term distinction concrete.
...
Two production gotchas from the lab: the app's service principal must be granted
a Lakebase role (the lab uses `databricks_superuser` for convenience — in

...
You've now used Claude Code to ship a governed Databricks App end to end. From here:

- Fold this into a **repo-first, tested** workflow — see [Debugging & Testing Agents Locally](/agentic-coding/vscode/debugging-and-testing) and [A Repo-First AI Project](/agentic-coding/vscode/repo-first-project).
- Make deploys reproducible with [Asset Bundles](/agentic-coding/vscode/asset-bundles).
- Revisit the sibling [VS Code](/agentic-coding/vscode/intro) subtopic — the AI Dev Kit works with VS Code's assistants too ([AI Assistants & MCP](/agentic-coding/vscode/ai-assistants-and-mcp)).
- Go deeper on *what* you're building in the [Databricks AI](/docs/intro) track.

Nicely done — you drove an agent to build an app that fronts another agent. That's agentic

...
installed so the assistant can reach your workspace over MCP. The next page uses this
setup to build a real Databricks App.
...
- Read the [Claude Code overview](/agentic-coding/claude-code/intro) so the agentic-loop mental model is fresh.
...
Your assistant can now reach Databricks, governed and as you. Time to put it to work and
ship something real.
